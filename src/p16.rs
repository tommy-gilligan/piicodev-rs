...
//     fn init_inner(self) -> Result<P16<I2C, Initialized>, mfrc522::error::Error<I2C::Error>> {
//         let res: P16<_, Initialized> = P16 {
//             mfrc522: self.mfrc522.init_inner()?,
//         };
//         Ok(res)
//     }
// }
...
//
//         let mut p16 = P16 {
//             mfrc522: Mfrc522::new(I2cInterface::new(i2c, 0x2C)).init_inner().unwrap(),
//         };
