...
//! [Alternate Driver]: https://github.com/braincore/vl53l1x-rs
//! [Alternate Driver]: https://github.com/TomSievers/vl53l1x-rs
...
mod test {
    ...
    pub fn new() {
        ...
        P7::new(i2c, 0x29, embedded_hal_mock::eh1::delay::NoopDelay {})
            .unwrap()
            .init()
            .unwrap();
        i2c_clone.done();
